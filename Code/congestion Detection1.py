...
model = YOLO("C:/Users/addua/Downloads/yolov8n.pt")
...
# Open the video
cap = cv2.VideoCapture("C:/Users/addua/Downloads/sample_video.avi")

# Define the codec and create VideoWriter object
fourcc = cv2.VideoWriter_fourcc(*'XVID')
out = cv2.VideoWriter('C:/Users/addua/Downloads/traffic_density_analysis.avi', fourcc, 20.0, (int(cap.get(3)), int(cap.get(4))))
...
while cap.isOpened():
    ...
    if ret:
        ...
        best_model_path="C:/Users/addua/Downloads/best.pt"
